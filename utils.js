/**
 * utils.js - Utility Functions (NO ENCRYPTION)
...
// ==================== STRING UTILITIES (NO ENCRYPTION) ====================
export const StrUtils = {
    /**
     * ⭐ NO ENCRYPTION - Pass through plaintext
     */
    xorCipher(text, key = CONFIG.message.encryptionKey) {
        return text; // Gửi thẳng không mã hóa
    },

    /**
     * ⭐ NO DECRYPTION - Pass through plaintext
     */
    xorDecipher(encrypted, key = CONFIG.message.encryptionKey) {
        return encrypted; // Nhận thẳng không giải mã
    },
